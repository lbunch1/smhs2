<template>
  <div class="content mt-36">
    ...
    <form id="login" class="flex flex-col items-center gap-4 p-12">
      ...
      " id="signin" type="submit" @click="signInWithEmail" class="p-2 rounded-md w-80 bg-primary hover:shadow-lg text-white">Log In</button>
      <div v-else class="p-2 rounded-md w-80 bg-light text-white text-center cursor-default">Log In</div>
    </form>
